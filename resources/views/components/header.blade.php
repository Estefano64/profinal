    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <button onclick="window.location='{{ route('login') }}'" class="hidden px-4 py-2 text-xs font-bold uppercase text-white bg-gradient-to-tr from-gray-900 to-gray-800 rounded-lg shadow-md transition-all hover:shadow-lg active:opacity-85 lg:inline-block" type="button">
                    Iniciar Sesión
                </button>
            </div>
