...
<section id="Projects" class="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="{{ asset('imghome/combopersonal.png') }}" alt="Product" class="h-80 w-172 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">

                <p class="text-center text-lg font-bold text-black truncate block capitalize">COMBOS PERSONALES </p>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="{{ asset('imghome/comboparados.jpg') }}" alt="Product" class="h-80 w-172 object-cover rounded-t-xl" />
            <div class="px-4 py-3 w-72">

                <p class="text-center text-lg font-bold text-black truncate block capitalize">COMBOS PARA 2</p>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            <img src="{{ asset('imghome/combofamiliar.jpg') }}" alt="Product" class="h-80 w-172 object-cover rounded-t-xl"/>
            <div class="px-4 py-3 w-72">

                <p class="text-center text-lg font-bold text-black truncate block capitalize">COMBOS FAMILIARES</p>
...
<div class="text-center p-10">
    ...
    <h1 class="text-3xl"> Polleria MIGUELON les ofrece</h1>
</div>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="{{ route('brasas')}}">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <p class="text-lg font-bold text-black truncate block capitalize">BRASAS</p>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="{{ route('piqueos')}}">
            ...
            <div class="px-4 py-3 w-172">
                ...
                <p class="text-lg font-bold text-black truncate block capitalize">PIQUEOS</p>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="{{ route('extras')}}">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <p class="text-lg font-bold text-black truncate block capitalize">ACOMPAÑAMIENTOS</p>
    ...
    <div class="w-172 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="{{ route('bebidas')}}">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <p class="text-lg font-bold text-black truncate block capitalize">BEBIDAS</p>
