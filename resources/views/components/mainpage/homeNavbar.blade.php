<nav class="fixed top-0 left-0 w-full z-50 flex flex-wrap items-center justify-between p-3 bg-[#e8e8e5]">
    ...
    <div class=" toggle hidden w-full md:w-auto md:flex text-right text-bold mt-5 md:mt-0 md:border-none">
        <a href="{{ route('establecimiento') }}" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Establecimientos
        </a>
        <a href="{{ route('contacto') }}" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Contacto
        </a>
        <a href="{{ route('quienes-somos') }}" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Sobre Nosotros
        </a>
